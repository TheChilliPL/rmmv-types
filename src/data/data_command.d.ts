...
declare type Data_ConditionalBranchParameters = [
    ...
    type: Data_ConditionalBranchType.Character,
    direction: Dir4
] | [
    ...
    type: Data_ConditionalBranchType.Item,
    itemId: number
] | [
    ...
    type: Data_ConditionalBranchType.Button,
    key: Key
] | [
    type: Data_ConditionalBranchType.Script,
    script: string
] | [
    type: Data_ConditionalBranchType.Vehicle,
...
declare type Data_ControlVariablesComparator = [
    ...
    operand: Data_ControlVariablesOperand.Constant,
    constant: number
] | [
    operand: Data_ControlVariablesOperand.Variable,
    variableId: number
] | [
...
declare type Data_ControlTimerParameters = [
    ...
    command: Data_ControlTimerCommand.Start,
    seconds: number
] | [
...
declare type Data_OperateValueOperand = [
    ...
    operandType: Data_OperateValueOperandType.Constant,
    value: number
] | [
    operandType: Data_OperateValueOperandType.Variable,
    variable: number
];
...
declare type Data_ChangePartyMemberParameters = [
    ...
    actorId: number,
    operation: Data_ChangePartyMemberOperation.Remove
];
...
declare type Data_EventTransferParameters = [
    ...
    type: Data_EventTransferDestinationType.Direct
...
declare type Data_CommandParameters = {
    ...
    [Data_CommandType.InputNumber]: [
        variableId: number,
        maxDigits: number
    ];
    [Data_CommandType.SelectItem]: [
        variableId: number,
        itemType?: Data_ItemType
    ];
    [Data_CommandType.ShowScrollingText]: [
        speed: number,
        noFast: boolean
    ];
    ...
    [Data_CommandType.CommonEvent]: [
        commonEventId: number
    ];

    [Data_CommandType.Label]: [
        label: string
    ];
    [Data_CommandType.JumpToLabel]: [
        label: string
    ];
    ...
    [Data_CommandType.RotatePicture]: [
        pictureId: number,
        angle: number
    ];
    ...
    [Data_CommandType.NameInputProcessing]: [
        actorId: number,
        maxLength: number
    ];
    ...
    [Data_CommandType.ChangeNickname]: [
        actorId: number,
        nickname: string
    ];
    [Data_CommandType.ChangeProfile]: [
        actorId: number,
        profile: string
    ]
};
